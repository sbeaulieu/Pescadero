...
#    start<-ymd_hms(chem_end)-minutes(10) #sets temp_start to 10min before the end of chemical measurements if chemistry taken for 10 minutes or more
    start<-ymd_hms(chem_end)-minutes(15) #sets temp_start to 15min before the end of chemical measurements if chemistry taken for 15 minutes or more
}
...
#    start<-temp_start(chemical_times_csv,4,"away") we think 10 min earlier using our end time
    start<-"2017-11-02 04:06:00"
...
columns<-c("Chem Start","Chem End","Temp Start","Temp End","Maximum","Minimum","Mean","Median","Range","Variance","St. Dev.","St. Err. Mean") #order of data in ea. vector
colnames(all)<-columns #labels matrix

print(all) #print matrix created above
